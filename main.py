...
print("1 - Fácil, 2 - Medio, 3 - Dificíl")
...
for rodada in range(1, total_de_tentativas +1):
    ...
    if valor_escolhido < 1 or valor_escolhido > 100:
        print("Número invalido. o número deve ser entre 1 e 100")
        continue
        ...
        if acertou:
            ...
            if maior:
                print("Você errou, o nùmero escolhido foi maior que o número secreto")
            elif menor :
                print("Você errou, o numeri escolhido foi menor que o número secreto")
